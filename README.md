...
| [OSM BuildingAnalyzer](https://github.com/KIT-IAI/SDM_Plugin_OSM_BuilldingAnalyzer) (under development) | Analysis of OSM building data for use in thermal building simulation |
